namespace CashInBox
{
    partial class frmRelatorioMembrosPorGrupo
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dsMembrosPorGrupo = new CashInBox.DataSets.dsMembrosPorGrupo();
            ...
            this.MembrosTableAdapter = new CashInBox.DataSets.dsMembrosPorGrupoTableAdapters.MembrosTableAdapter();
            ...
            this.rptRelGruposPorMembros.LocalReport.ReportEmbeddedResource = "CashInBox.Reports.rptRelatorioMembrosPorGrupo.rdlc";
        ...
        private DataSets.dsMembrosPorGrupo dsMembrosPorGrupo;
        private DataSets.dsMembrosPorGrupoTableAdapters.MembrosTableAdapter MembrosTableAdapter;
    }
}