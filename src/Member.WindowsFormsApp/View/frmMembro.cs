...
namespace CashInBox
{
    public partial class frmMembro : Form
    {
        ...
        private void ObterDadosMembro(Membro memb, bool backM, bool next)
        {
            ...
            dtpDataEntrada.Value = memb.DataEntrada == DateTime.MinValue ? DateTime.Now : memb.DataEntrada;
            dtpDataSaida.Value = memb.DataSaida == DateTime.MinValue ? DateTime.Now : memb.DataSaida;
