namespace CashInBox
{
    partial class frmRelDoutrinario
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dsDoutrinario = new CashInBox.dsDoutrinario();
            ...
            reportDataSource2.Name = "dsDoutrinario";
            reportDataSource2.Value = this.DoutrinarioBindingSource;
            this.rptRelFinanceiro.LocalReport.DataSources.Add(reportDataSource2);
            this.rptRelFinanceiro.LocalReport.ReportEmbeddedResource = "CashInBox.rptDoutrinario.rdlc";
        ...
        private dsDoutrinario dsDoutrinario;
